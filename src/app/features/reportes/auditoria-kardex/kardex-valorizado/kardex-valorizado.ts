...
import { KardexAuditoriaService, KardexAuditoriaCompleta, KardexAuditoriaItem } from '../services/kardex-auditoria.service';
...
@Component({
    ...
    templateUrl: './kardex-valorizado.html',
    styleUrl: './kardex-valorizado.scss'
})
export default class KardexValorizado implements OnInit {
